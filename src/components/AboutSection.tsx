...
export const AboutSection = () => {
  return <section id="about" className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-900/50">
            ...
            <div className="bg-gradient-to-br from-purple-600/20 to-pink-600/20 p-8 rounded-xl border border-purple-500/30">
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {['Big Data Processing & Analytics', 'Real-time & Batch Data Pipelines', 'Cloud-Native Data Solutions', 'Data Modeling & Architecture', 'ETL/ELT Pipeline Development', 'Performance Optimization'].map((item, index) => <motion.div key={item} initial={{
                  opacity: 0,
                  x: 20
                }} whileInView={{
                  opacity: 1,
